...
public class AsteroidWormhole : MonoBehaviour {
    ...
    public static float MinFireInterval = 0.15f;
    public static float MaxFireInterval = 0.3f;
    ...
    IEnumerator IEShootAsteroid() {
        ...
        for (int i = 0; i < batchSize; i++) {
            ...
            newAsteroid.velocity = Asteroid.Speed * (target.transform.position - transform.position).normalized;
